...
<body>
    ...
    <section id="btn-container">
        ...
        <a href="#"><button class="sembtn active">Fifth Semester</button></a>
    ...
    <form action="./sem5process.php" method="post" autocomplete="off">
    <div class="main">
    <table>
        <tr>
            <th></th>
...
<!------------------------------------------------------------------------------------------------------------------------------->
        ...
        <tr>
            ...
            <td>
                <?php
                $couSql = "SELECT * FROM courses WHERE sem = 5";
