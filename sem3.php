...
<body>
    ...
    <section id="btn-container">
        ...
        <a href="#"><button class="sembtn active">Third Semester</button></a>
    ...
    <form action="./sem3process.php" method="post" autocomplete="off">
    <div class="main">
    <table>
        <tr>
            <th></th>
...
<!------------------------------------------------------------------------------------------------------------------------------->
        ...
        <tr>
            ...
            <td  style="padding: 12px;">
                <?php
                $couSql = "SELECT * FROM courses WHERE sem = 3";
