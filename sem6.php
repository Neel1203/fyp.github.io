...
<body>
    ...
    <section id="btn-container">
        ...
        <a href="#"><button class="sembtn active">Sixth Semester</button></a>
    </section>
    </div>
    ...
    <form action="./sem6process.php" method="post" autocomplete="off">
    <div class="main">
    <table>
        <tr>
            <th></th>
...
<!------------------------------------------------------------------------------------------------------------------------------->
        ...
        <tr>
            ...
            <td>
                <?php
                $couSql = "SELECT * FROM courses WHERE sem = 6";
